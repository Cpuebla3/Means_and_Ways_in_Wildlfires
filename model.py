...
class WildfireModel(mesa.Model):
    def __init__(
        ...
        num_sectors=4,
        tif_p="cali_test_big_enhanced.tif",
        ...
        self.fire = self.initialize_fire(fuel_model_override, tif_p)
    ...
    #     )
    def initialize_fire(self, fuel_model_override=None, tif_p="cali_test_big_enhanced.tif"):
        tif_path = Path().joinpath(tif_p).resolve()
